...
//questo è l'oggettoche costituirà l'evento nel topic order event e conterrà tutte le info che
    // si devono fornire a PaymentServer (Consumer) per effettuare il pagamento
